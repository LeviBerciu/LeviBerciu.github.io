...
/*
  ARjs.Source.prototype.copyElementSizeTo = function(otherElement){		  ARjs.Source.prototype.copyElementSizeTo = function(otherElement){
  	...
  	otherElement.style.marginTop = this.domElement.style.marginTop		  	otherElement.style.marginTop = this.domElement.style.marginTop
  }		  }
 +*/
